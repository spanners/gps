...
def has_aspects(subp_decl_node):
    ...
    return hasattr(subp_decl_node, 'f_aspects') and \
        bool(subp_decl_node.f_aspects)
...
def get_aspect_line(line, subp_decl_node):
    ...
    # Obtain the subprogram specification for further filtering
    if isinstance(subp_decl_node, lal.SubpSpec):
        subp_spec = subp_decl_node
    else:
